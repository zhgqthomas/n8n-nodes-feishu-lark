...
export default {
	...
	options: [
		...
		},
		{
			...
			type: 'json',
			default: '{}',
			description: 'Https://open.feishu.cn/document/server-docs/docs/docs/docx-v1/document-block/patch#1b8abd5d',
		},
	],
	async call(this: IExecuteFunctions, index: number): Promise<IDataObject> {
		...
		if (code !== 0) {
			throw new Error(`Update block content failed, code: ${code}, message: ${msg}`);
		}
