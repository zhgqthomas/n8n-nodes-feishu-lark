...
export default {
	...
	options: [
		...
		},
		{
			...
			default: 'open_id',
			description: 'Https://open.feishu.cn/document/server-docs/docs/bitable-v1/app-table-record/create#queryParams',
		},
		{
		...
		},
		{
			...
			required: true,
			default: '{"fields":{}}',
			description: 'Https://open.feishu.cn/document/server-docs/docs/bitable-v1/app-table-record/create#requestBody',
		},
	],
