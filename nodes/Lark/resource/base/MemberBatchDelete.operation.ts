...
export default {
	...
	options: [
		...
		},
		{
			...
			description: 'Https://open.feishu.cn/document/server-docs/docs/bitable-v1/advanced-permission/app-role-member/batch_delete#requestBody',
		},
	],
	async call(this: IExecuteFunctions, index: number): Promise<IDataObject> {
		...
		if (code !== 0) {
			throw new Error(`Error batch delete role member: code:${code}, message:${msg}`);
		}
