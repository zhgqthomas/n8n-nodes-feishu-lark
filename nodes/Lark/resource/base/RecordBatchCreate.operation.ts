...
export default {
	...
	options: [
		...
		},
		{
			...
			default: 'open_id',
			description: 'Https://open.feishu.cn/document/server-docs/docs/bitable-v1/app-table-record/batch_create#queryParams',
		},
		{
		...
		},
		{
			...
			required: true,
			default: '{"records":[]}',
			description: 'Https://open.feishu.cn/document/server-docs/docs/bitable-v1/app-table-record/batch_create#requestBody',
		},
	],
	async call(this: IExecuteFunctions, index: number): Promise<IDataObject[]> {
		...
		if (code !== 0) {
			throw new Error(`Error creating base record: code:${code}, message:${msg}`);
		}
