...
export default {
	name: WORDING.CardUpdateElement,
	value: OperationType.CardUpdateElement,
	order: 200,
	options: [
		...
		{
			displayName: `<a target="_blank" href="https://open.feishu.cn/document/cardkit-v1/card-element/update">${WORDING.OpenDocument}</a>`,
			name: 'notice',
			type: 'notice',
			default: '',
		},
